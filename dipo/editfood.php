						...
						if(isset($_GET['edid']))
                            ...
                            <div class="form-row">
								...
								<div class="col-md-3">
                                    ...
                                    <input type="number" name="rate" class="form-control" value="<?php echo $rate;?>" id="validationCustom02" placeholder="rate" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
								...
								<div class="col-md-3">
                                    ...
                                    <input type="number" name="qty" class="form-control" value="<?php echo $qty;?>" id="validationCustom02" placeholder="qty" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="number" name="subcidy" class="form-control" value="<?php echo $subcidy;?>" id="validationCustom02" placeholder="subcidy" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
