                        ...
                        <form action="#" method="post" class="needs-validation" novalidate>
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="lname" value="<?php echo $lname; ?>" class="form-control" id="validationCustom02" placeholder="Last name" option>
							...
							<div class="col-md-6 mb-6">
                                    ...
                                    <input type="number" name="phno" pattern="[0-9]{10}" value="<?php echo $phno; ?>"class="form-control" id="validationCustom03" placeholder="Phone number" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text"  name="pin_code" value="<?php echo $pin_code; ?>  "class="form-control" id="inputZip"  placeholder="Pin code">
                                </div>
                            </div>
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update add_staff set fname='".$fname."',lname='".$lname."',phno='".$phno."',address='".$address."',city='".$city."' ,pin_code='".$pin_code."' where s_id='".$eid."'";
