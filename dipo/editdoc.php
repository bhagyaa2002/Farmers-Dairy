             ...
             <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                       ...
                       <h5 class="mt-5">Edit Doctor Details</h5>
                        <hr>
						<?php
						...
						if(isset($_GET['edid']))
							{
								$eid=$_GET['edid'];
								include 'config.php';
								$sql1 = "select * from add_doctor where doc_id='".$eid."'";
                        ...
                        <form action="#" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="name" value="<?php echo $name; ?> " class="form-control" id="validationCustom01" placeholder="Doctor Name" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="address" value="<?php echo $address; ?> "class="form-control" id="validationCustom02" placeholder="Address" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="text" name="phoneno" pattern="[0-9]{10}" value="<?php echo $phoneno; ?> "class="form-control" id="validationCustom02" placeholder="contact no" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
							...
							<div class="col-md-3">
                                    ...
                                    <input type="text" name="opening_time" value="<?php echo $opening_time; ?> "class="form-control" id="validationCustom02" placeholder="opening_time" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="text" name="closing_time" value="<?php echo $closing_time; ?> "class="form-control" id="validationCustom02" placeholder="closing_time" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update add_doctor set name='".$name."',address='".$address."',phoneno='".$phoneno."',opening_time='".$opening_time."',closing_time='".$closing_time."' where doc_id='$eid'";
