                        ...
                        <form class="needs-validation" action="#" method="post">
                            <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $mname;?>" placeholder="Name" name="mname" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="rate" class="form-control" value="<?php echo $rate;?>" placeholder="rate" required>
                                    <div class="valid-feedback">
                                        Rate!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="number" name="qty" class="form-control" value="<?php echo $qty;?>" placeholder="rate" required>
                                    <div class="valid-feedback">
                                        Quantity!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="text" name="descr" class="form-control" value="<?php echo $descr;?>" placeholder="Description" required>
                                    <div class="valid-feedback">
                                       Description!
                                    </div>
                                </div>
