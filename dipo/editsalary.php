                       ...
                       <h5 class="mt-5">Staff Salary</h5>
                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="col-md-6 mb-6">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom03" pattern="[0-9]{10}" placeholder="Phone number" required>
                                ...
                                <div class="col-6 md-6">
								  <label for="validationCustom01">Account Number</label>
                                    <input type="number" class="form-control" id="validationCustom01" placeholder="Account number" required>
                                    <div class="valid-feedback">
							...
							<div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom02" placeholder="IFSC" required>
                                    <div class="valid-feedback">
							...
							<div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom02" placeholder="salary" required>
                                    <div class="valid-feedback">
