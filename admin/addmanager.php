                       ...
                       <h5 class="mt-5">Manager Register</h5>
                        ...
                        <form class="needs-validation" novalidate action="#" method="post">
							...
							<div class="col-md-6 mb-6">
                                    ...
                                    <input type="number" class="form-control" id="validationCustom03" name="phoneno" pattern="[0-9]{10}" placeholder="Phone number" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="inputState" class="form-control" name="state" placeholder="State" required>
						...
						if(isset($_POST['save']))
{
	...
	else
	{
		...
		$query = "insert into add_manager(fname,lname,email,password,phoneno,address,city,state,pin_code) values('".$fname."','".$lname."','".$email."','".$password."','".$phoneno."','".$address."','".$city."','".$state."','".$pincode."')";
